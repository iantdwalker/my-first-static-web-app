An example from October 2021 of how to deploy a basic Angular application to Azure as a Static Web App using GitHub Actions. No longer actively being worked on.
